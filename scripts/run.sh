...
# Russian embeddings
# python src/calculate_uniform_norm.py --model_name models/fasttext-ru-torch --whitening_mode "PCA"
# python src/calculate_uniform_norm.py --model_name models/geowac_tokens_none_fasttextskipgram_300_5_2020-torch --whitening_mode "PCA"
...
# Russian embeddings
# python src/calculate_zipfian_norm.py --model_name models/fasttext-ru-torch --whitening_mode "PCA"
# python src/calculate_zipfian_norm.py --model_name models/geowac_tokens_none_fasttextskipgram_300_5_2020-torch --whitening_mode "PCA"
...
# python src/run_eval.py --model_name models/fasttext-ru-torch
# python src/run_eval.py --model_name models/geowac_tokens_none_fasttextskipgram_300_5_2020-torch
...
python src/run_eval.py --model_name models/fasttext-ru-torch --in_batch True
python src/run_eval.py --model_name models/geowac_tokens_none_fasttextskipgram_300_5_2020-torch --in_batch True
...
# python src/calc_isotropy_score.py --model_name models/fasttext-ru-torch
# python src/calc_isotropy_score.py --model_name models/geowac_tokens_none_fasttextskipgram_300_5_2020-torch


# run norm experiments
# echo "Running norm experiments on average_word_embeddings_glove.840B.300d"
# python src/run_norm_experiments.py --model_name sentence-transformers/average_word_embeddings_glove.840B.300d --topk 750
# echo "Running norm experiments on GoogleNews-vectors-negative300-torch"
# python src/run_norm_experiments.py --model_name models/GoogleNews-vectors-negative300-torch --topk 750
# echo "Running norm experiments on models/fasttext-en-torch"
# python src/run_norm_experiments.py --model_name models/fasttext-en-torch --topk 750
# echo "Running norm experiments on GoogleNews-vectors-negative300-torch"
# python src/run_norm_experiments.py --model_name models/fasttext-en-subword-torch --topk 750

# echo "Running norm experiments on models/fasttext-ru-torch"
# python src/run_norm_experiments.py --model_name models/fasttext-ru-torch --topk 750
# echo "Running norm experiments on models/geowac_tokens_none_fasttextskipgram_300_5_2020-torch"
# python src/run_norm_experiments.py --model_name models/geowac_tokens_none_fasttextskipgram_300_5_2020-torch --topk 750